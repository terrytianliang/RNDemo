...
<module external.linked.project.id=":react-native-svg" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../cbmms-android/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
